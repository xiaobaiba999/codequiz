  ...
  return (
    <div>
      ...
      <Row gutter={16} style={{ marginBottom: 24 }}>
        <Col span={6}><Card><Statistic title="总做题数" value={stats.totalAnswered} /></Card></Col>
        <Col span={6}><Card><Statistic title="正确数" value={stats.totalCorrect} /></Card></Col>
        <Col span={6}><Card><Statistic title="正确率" value={stats.overallAccuracy} suffix="%" /></Card></Col>
        <Col span={6}><Card><Statistic title="连续天数" value={stats.streakDays} suffix="天" /></Card></Col>
      </Row>
